/**
 * Result intercom — construct the grouped subagent result payload: status
 * resolution, nested-run compaction, message formatting, and payload assembly.
 */
...
export function countStatuses(children: SubagentResultIntercomChild[]): Record<SubagentResultStatus, number> {
...
export function formatStatusCounts(counts: Record<SubagentResultStatus, number>): string {
	const parts = [
