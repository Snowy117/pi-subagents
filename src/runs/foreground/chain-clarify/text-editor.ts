/**
 * Inline text-editor helpers for the chain clarification TUI component.
 *
 * Pure functions operating on an explicit editor state (no `this`); grouped
 * here so the component module stays focused on orchestration. Only the
 * symbols used by the component are exported; word-cursor / normalization
 * helpers remain private to this module.
 */
