...
import { Container, Spacer, Text } from "./render.ts";
...
import { formatTotalCostStat } from "./stats.ts";
import { getTermWidth, truncLine } from "./text-wrap.ts";
import { modelThinkingBadge, widgetStepStatus } from "./widget-core.ts";

export function renderMultiExpanded(d: Details, theme: Theme, expanded: boolean): Container {
