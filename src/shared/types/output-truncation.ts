/**
 * Output truncation: cap captured subagent output to byte/line budgets,
 * emitting a human-readable truncation marker. TruncationResult is the
 * shared descriptor consumed by SingleResult and truncateOutput.
 */
