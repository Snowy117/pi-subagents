...
export const SUBAGENT_ACTIONS = ["list", "get", "models", "create", "update", "delete", "eject", "disable", "enable", "reset", "status", "interrupt", "resume", "steer", "doctor", "schedule", "schedule-list", "schedule-status", "schedule-cancel", "wait"] as const;
